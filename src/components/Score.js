    ...
    <div className="flex flex-col items-center justify-center gap-5 m-10">
      <div>
        ...
        <div className="items-center">
          {
            scorePercentage < 50 ? <img alt="Sad mickey" src="sad.png" className="h-72 ml-12 mr-5 my-5 " /> :
              ((scorePercentage >= 50 && scorePercentage < 80) ? <img alt="happy mickey" src="medium.png" className="h-72 ml-12 mr-5 my-5 " /> : <img alt="super happy mickey" src="happy.png" className="h-72 ml-12 mr-5 my-5 " />)
          }
        </div>
